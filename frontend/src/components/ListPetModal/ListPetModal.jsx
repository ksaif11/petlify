...
import "./ListPetModal.css";

const ListPetModal = ({ onClose, onPetAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.species || !formData.breed || !formData.age || !formData.description) {
    ...
    formData.images.forEach((img) => {
      petData.append("images", img.file);
    });
